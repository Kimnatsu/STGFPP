...
(function () {
  ...
  function renderPatchDetail(id) {
    ...
    likeState('patch', p.docId, p.likeCount);
    el.innerHTML =
  ...
  function actionRow(type, id, title) {
    return '<div class="detail-actions">' +
      ...
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="6" cy="12" r="2.6"/><circle cx="17.5" cy="5.5" r="2.6"/><circle cx="17.5" cy="18.5" r="2.6"/><path d="M8.4 10.8l6.8-4M8.4 13.2l6.8 4"/></svg>' +
  ...
  function renderBoardDetail(id) {
    ...
    el.innerHTML =
      ...
      '<div class="detail-body">' + UI.renderContent(b.text) + bodyImages + '</div>' +
  ...
  function renderEventDetail(id) {
    ...
    el.innerHTML =
      ...
      (evPeriod(e) ? '<span>·</span><span class="ev-period"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3.5 2" stroke-linecap="round"/></svg>' + evPeriod(e) + '</span>' : '') +
      '</div></div>' +
